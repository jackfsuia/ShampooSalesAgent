...
Support all models, including openai models, huggingface models, claude, gemini, baichuan(百川), qwen(通义千问), moonshot(月之暗面), ernie(文心一言), glm(智谱), deepseek(深度求索). Very friendly for beginners, researchers and interested businessman who want to try things out quick.
