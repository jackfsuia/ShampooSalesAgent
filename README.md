...
Support OpenAI models, HuggingFace models, Claude, Gemini, Baichuan(百川), Qwen(通义千问), Moonshot(月之暗面), Ernie(文心一言), Glm(智谱), Deepseek(深度求索). Very friendly for beginners, researchers and interested businessman who want to try things out quick.
